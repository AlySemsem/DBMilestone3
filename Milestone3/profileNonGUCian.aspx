<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profileNonGUCian.aspx.cs" Inherits="Milestone3.profileNonGUCian" %>
...
<body>
    <form id="form1" runat="server">
       <p style="font-size:50px"><strong>Student Profile</strong></p>
        ...
        <br />
        <p style="font-size:20px"><strong>My Courses:</strong></p>
        <table border ="1">
                <thead>
                <tr>
                    <th>Course ID</th>
                ...
                <tbody id="courseBody" runat="server">
                </tbody>
            </table>
